...
class msYaMarketItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('msyamarket_item_err_ns');
        }
...
return 'msYaMarketItemUpdateProcessor';
