...
$_lang = array_merge($_lang ?? [], [
    ...
    'ym_yandex.market_currencies'            => 'Список курсов валют магазина (первая - основная валюта)',
    ...
    'ym_yandex.market_enable_auto_discounts' => 'Автоматический расчет и показ скидок (для всего прайс-листа)',
