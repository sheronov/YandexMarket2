...
export default [
    {value: TYPE_ROOT, text: 'корневой', selectable: false},
    ...
    {value: TYPE_OPTION, text: 'текстовая опция', selectable: false},
    {value: TYPE_FEATURE, text: 'ещё не реализовано', selectable: false},
    {value: TYPE_STRING, text: 'строка'},
    {value: TYPE_CDATA, text: 'текст в CDATA'},
    {value: TYPE_NUMBER, text: 'число'},
    {value: TYPE_BOOLEAN, text: 'да/нет'},
    {value: TYPE_PARAM, text: 'параметр'},
